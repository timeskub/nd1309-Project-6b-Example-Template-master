...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
        ...
        // // Changed this variable name to myEvent
        // var event = supplyChain.Harvested() 
        // event.on('data', (event) => {
        //     eventEmitted = true;
        // })
        ...
        // https://knowledge.udacity.com/questions/616483

        /*The problem with the event emitters in the test cases is that it is written in the old version. In order to avoid this, 
        if you don't want to comment the code and still want to add the events then I would recommend to use this truffle-assertions npm package. */ 
        ...
        // console.log("result.logs[0].event", result.logs[0].event)
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        assert.equal(resultBufferTwo[4], productPrice.toString(), 'Error: Missing or Invalid Price')
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        assert.equal(resultBufferTwo[4], productPrice.toString(), 'Error: Missing or Invalid productPrice')
